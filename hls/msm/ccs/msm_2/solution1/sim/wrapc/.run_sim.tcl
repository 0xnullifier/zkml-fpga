...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "msm.autotvin.dat"
	set constFileTvOut       "msm.autotvout.dat"
	set constFileHdlTvIn     "msm.autohdltvin.dat"
	set constFileHdlTvOut    "msm.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
