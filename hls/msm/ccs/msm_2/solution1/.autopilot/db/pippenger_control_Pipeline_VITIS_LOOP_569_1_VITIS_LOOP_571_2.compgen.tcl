...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pippenger_control_pippenger_control_Pipeline_VITIS_LOOP_569_1_VITIS_LOOP_571_2_buckets_y_0_RAM_bkb BINDTYPE {storage} TYPE {ram_t2p} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}
