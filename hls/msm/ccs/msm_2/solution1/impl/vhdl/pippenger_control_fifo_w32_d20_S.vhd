...
entity pippenger_control_fifo_w32_d20_S is 
    generic (
...
architecture rtl of pippenger_control_fifo_w32_d20_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component pippenger_control_fifo_w32_d20_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 20);
...
begin
----------------------- Instantiation -----------------------
    U_pippenger_control_fifo_w32_d20_S_ShiftReg : pippenger_control_fifo_w32_d20_S_ShiftReg
    generic map (
...
entity pippenger_control_fifo_w32_d20_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 20);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end pippenger_control_fifo_w32_d20_S_ShiftReg;

architecture rtl of pippenger_control_fifo_w32_d20_S_ShiftReg is
