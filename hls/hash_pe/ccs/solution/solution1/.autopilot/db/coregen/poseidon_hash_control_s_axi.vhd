...
entity poseidon_hash_control_s_axi is
generic (
...
end entity poseidon_hash_control_s_axi;
...
architecture behave of poseidon_hash_control_s_axi is
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_num_blocks(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
